...
class Count2Page extends React.Component<CountPageProps, CountPageState> {
...
export default dynamic(MODULE_NAME, attachReducer(reducer), runSaga(saga))(withConnect(Count2Page));
